...
void solar_system(SpaceDemo &demo)
{
    ...
    Planet planets[] = {
        { "mercury", 0.387, 1.660e-7, 1.45e-5, { 0.5, 0.5, 0.5, 1.0 } },
        { "venus", 0.723, 2.447e-6, 3.75e-5, { 1.0, 0.8, 0.0, 1.0 } },
        { "earth", 1.000, 3.003e-6, 3.37e-5, { 0.0, 0.0, 1.0, 1.0 } },
        { "mars", 1.524, 3.213e-7, 1.79e-5, { 1.0, 0.0, 0.0, 1.0 } },
        { "jupiter", 5.203, 9.545e-4, 3.78e-4, { 1.0, 0.5, 0.0, 1.0 } },
        { "saturn", 9.537, 2.857e-4, 3.21e-4, { 1.0, 1.0, 0.5, 1.0 } },
        { "uranus", 19.191, 4.364e-5, 1.36e-4, { 0.5, 1.0, 1.0, 1.0 } },
        { "neptune", 30.068, 5.148e-5, 1.33e-4, { 0.0, 0.0, 0.5, 1.0 } }
    };
